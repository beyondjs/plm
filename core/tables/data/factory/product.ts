...
export abstract class Product extends Events {
    ...
    // The key generated by CompareObjects.generate(filter, attributes)
    readonly #key: string
    get key() {
        return this.#key
    }
     ...
     * @param {string} key The key generated by CompareObjects.generate(filter, attributes)
     * @param {number} instanceId The auto-numeric instance id generated by the manager
     * @protected
     */
    protected constructor(manager: Factory<any>, key: string, instanceId: number) {
        super();
